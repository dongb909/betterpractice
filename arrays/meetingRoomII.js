...
//other heap only maintains meeting that's happening and then evict rooms when incoming meeting is starting later than what's at top of heap and add new room in, comparing 1 item to see if it's overlatpping and then evitt one of them